...
public class StudentDTO {
    ...
    public StudentDTO(String name, String username, String password) {
        this.name = name;
        this.username = username;
        this.password = password;
    }

    public StudentDTO(String name, String username, String password, Date birthDate, Character sex, String street, String city, String state, Integer postalCode, String phone, String email, Integer rg, String orgExp, Integer cpf) {
        this.name = name;
        this.username = username;
        this.password = password;
